// Firstly addFolder() function call then  it will pass name of the folder and id of that folder  to 
//addFolderHtML() function then on whatever we click that function will call .(eg. rename ,delete, etc). 
(function () {

    let btnAddFolder = document.querySelector("#addFolder");
    btnAddFolder.addEventListener("click", addFolder);

    // folder banane ka kam isi ka he 
    function addFolder() {
